...
d3.json("static/data/data_dg_worst.json", function(error, graphData) {
  console.log(graphData)
  d3.json("static/data/dataM_dg_worst.json", function(error, graphDataM) {
    console.log(graphData)
    d3.json("static/data/dataB_dg_worst.json", function(error, graphDataB) {
      d3.json("static/data/targets_dg_worst.json", function(error, targets) {
